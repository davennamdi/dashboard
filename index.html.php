...
<body>
	...
	<div class="hk-wrapper hk-vertical-nav">
                    ...
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span>test@test.com<i class="zmdi zmdi-chevron-down"></i></span>
                            </div>
                        </div>
                    </a>
        ...
        <div class="hk-pg-wrapper">
									...
									<div class="card-body pa-0">
											...
											<div class="row">
													<div class="col-sm">
														...
														<form action="/calc.php" methond="post">
																	...
																	<div class="form-group">
																		...
																		<div class="form-group">
																				...
																				<div class="input-group">
																					...
																					<input class="form-control" id="realEstate" placeholder="00.00" type="number">
																				</div>
																			</div>
																			...
																			<div class="form-group">
																					...
																					<div class="input-group">
																						...
																						<input class="form-control" id="otherInvestments" placeholder="00.00" type="number">
																					</div>
																				</div>
																				<div class="form-group">
																						...
																						<div class="input-group">
																							...
																							<input class="form-control" id="retirementSavings" placeholder="00.00" type="number">
																						</div>
																					</div>
                                                                ...
                                                                <!-- display values in showTotalAsset -->
                            <h5 class="hk-sec-title ">Total Assets: <span class="js--show-assets" id="showTotalAsset">0.00</span></h5>
													</div>
												</div>
																	...
																	<div class="form-group">
																		...
																		<div class="form-group">
																				...
																				<div class="input-group">
																					...
																					<input class="form-control" id="billsDue" placeholder="00.00" type="number">
																				</div>
																			</div>

                                                                            
                                                                <!-- display values in showTotalLiabilities -->	
		                                                                <h5 class="hk-sec-title" style="margin: 1.5rem 0;">Total Liabilities: <span id="showTotalLiabilities" class="js--show-liabilities">0.00</span></h5>
		

        
                                                                        <!-- calculate button -->
                                                                        <button type="button" class="btn btn-primary mr-10" id="calculateBtn" onclick="keyFunc()">Calculate</button>
            ...
            <h5 class="hk-sec-title" style="margin-top: 2.5rem;">Your Net Worth: <span class="js--show-networth" id="showNetWorth">0.00</span></h5> <br> <br>

            <hr>
            <h5 class="hk-sec-title" style="color:orangered;">Comparative Analysis <span class="js--show-networth"></span></h5>
           
            
                <h6 class="hk-sec-title" style="margin-top: 2.5rem;">Percentage (Total Assets): <span class="js--show-networth" id="assetPercentAssets"></span></h6>
                <h6 class="hk-sec-title" > Percentage (Total Liabilities): <span class="js--show-networth" id="assetPercentLiabilities"></span></h6>
                <hr>
